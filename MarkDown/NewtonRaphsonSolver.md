...
```math
T(\vec{\mathbb{x_{n}}}) = m\cdot\vec{\mathbb{x_{n}}}+b
```
...
```math
\mathbb{R}(\vec{x}_n) = T(\vec{\mathbb{x_n}}) = m\cdot\vec{\mathbb{x}}+b
```

Damit ergibt sich $b$ zu

```math
b = \mathbb{R}(x_{n})-{m\cdot\vec{\mathbb{x_{n}}}} = \mathbb{R}(x_{n})-{\dot{\mathbb{R}}(x_{n})\cdot\vec{\mathbb{x_{n}}}}
```

Die Tangente ergibt sich also zu

```math
T(\vec{\mathbb{x_{n}}}) = \dot{\mathbb{R}}(x_{n}) \cdot \vec{x} + \mathbb{R}(x_{n})-{\dot{\mathbb{R}}(x_{n})\cdot\vec{\mathbb{x_{n}}}}
```

und die Nullstelle der Tangente ist

```math
\vec{x}_{n+1} = x | T(\vec{\mathbb{x_{n}}}) = 0 
```

```math
\vec{x}_{n+1} = \frac{-\mathbb{R}(x_{n})+{\dot{\mathbb{R}}(x_{n})\cdot\vec{\mathbb{x_{n}}}}}{\dot{\mathbb{R}}(x_{n})}
```

Vereinfachen

```math
\vec{x}_{n+1} = -\frac{\mathbb{R}(x_{n})}{\dot{\mathbb{R}}(x_{n})}+\vec{\mathbb{x_{n}}}
```

anders schreiben

```math
\vec{x}_{n+1} = \vec{\mathbb{x_{n}}} +\Delta \vec{\mathbb{x_{n}}} | \Delta \vec{\mathbb{x_{n}}} = -\frac{\mathbb{R}(x_{n})}{\dot{\mathbb{R}}(x_{n})}
```
...
```math
while(\left| \mathbb{R}(\vec{x}_{n}) \right| > tolerance)\{ 
Iterationsschritt
\}
```
